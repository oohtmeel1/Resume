...
if check1:
	...
	variety of instruments.![Cool image](https://drive.google.com/uc?export=view&id=1zjzykI1bShq50pu1gkcp962afitfw35n)
  	I always enjoyed poring over the massive amounts of data that were generated during the course of some interval by work processes. 
	From tracking protein concentration changes over time, and communicating those changes during meetings, or tracking samples sent for outside testing to ensure timelines were being met, the Data Science portion 
	of my various jobs has always interested me. So, in pursuit of furthering my career 
